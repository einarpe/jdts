...
{
  // i think no need for explanation of those, am i not?...
  ...
  /** This connection does absolutely nothing useful, it is just a dummy. Used when no destination is specified and we want only csv files. */
  public final static Connection Empty = new Connection() 
  {
    @Override
